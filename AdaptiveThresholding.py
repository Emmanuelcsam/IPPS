...
# Load the sudoku image, which has shadows and varying illumination, in grayscale. [cite: 18]
img = cv.imread(base_path + 'img1.jpg', cv.IMREAD_GRAYSCALE)
assert img is not None, "file could not be read, check with os.path.exists()"

# Apply a median blur to reduce noise. This is often a good preprocessing step.
# The (5) indicates a 5x5 kernel size.
img = cv.medianBlur(img, 5)

# Perform global thresholding as a comparison. [cite: 18]
